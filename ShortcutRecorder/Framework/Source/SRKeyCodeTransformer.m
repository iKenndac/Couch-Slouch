...
+ (void) initialize;
{
	...
	keyCodeToStringDict = [[NSDictionary alloc] initWithObjectsAndKeys:
		...
		SRChar((unsigned short)KeyboardDeleteLeftGlyph), SRInt(51),
		SRChar((unsigned short)KeyboardDeleteRightGlyph), SRInt(117),
		SRChar((unsigned short)KeyboardPadClearGlyph), SRInt(71),
		SRChar((unsigned short)KeyboardLeftArrowGlyph), SRInt(123),
		SRChar((unsigned short)KeyboardRightArrowGlyph), SRInt(124),
		SRChar((unsigned short)KeyboardUpArrowGlyph), SRInt(126),
		SRChar((unsigned short)KeyboardDownArrowGlyph), SRInt(125),
		SRChar((unsigned short)KeyboardSoutheastArrowGlyph), SRInt(119),
		SRChar((unsigned short)KeyboardNorthwestArrowGlyph), SRInt(115),
		SRChar((unsigned short)KeyboardEscapeGlyph), SRInt(53),
		SRChar((unsigned short)KeyboardPageDownGlyph), SRInt(121),
		SRChar((unsigned short)KeyboardPageUpGlyph), SRInt(116),
		SRChar((unsigned short)KeyboardReturnR2LGlyph), SRInt(36),
		SRChar((unsigned short)KeyboardReturnGlyph), SRInt(76),
		SRChar((unsigned short)KeyboardTabRightGlyph), SRInt(48),
		SRChar((unsigned short)KeyboardHelpGlyph), SRInt(114),
		nil];    
