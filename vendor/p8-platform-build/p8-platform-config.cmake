...
set (p8-platform_INCLUDE_DIRS /usr/local/include/p8-platform /usr/local/include)
...
if(WIN32)
  set (p8-platform_LIBRARY "/usr/local/lib/p8-platform.lib")
else(WIN32)
  set (p8-platform_LIBRARY "-L/usr/local/lib -lp8-platform")
endif(WIN32)
